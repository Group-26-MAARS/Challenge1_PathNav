...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    ...
    /// scene.
    /// </summary>
    public class XRUXPickerForMainMenu : XRUXPicker
    {
        private static XRUXPickerForMainMenu _Instance;
        public new static XRUXPickerForMainMenu Instance
        {
            get
            {
                if (_Instance == null)
                {
                    _Instance = FindObjectOfType<XRUXPickerForMainMenu>();
                }
